    ...
    <div class="space-y-8">
      <section>
        ...
        <div class="pl-0 space-y-3 text-foreground/80">
          <p><strong>1. Hur upplever du din arbetssituation just nu?</strong> (Vad tar och ger dig energi?)</p>
          <p><br></p>
        </div>
      </section>
      ...
      <section>
        ...
        <div class="pl-0 space-y-3 text-foreground/80">
          ...
          <p><strong>3. Hur fungerar samarbetet med dina kollegor? </strong> (Något som kan fungera bättre?)</p>
          <p><br></p>
        </div>
      </section>
      ...
      <section>
        ...
        <div class="pl-0 space-y-3 text-foreground/80">
          ...
          <p><strong>9. Vad i samarbetet/dialogen med din chef tycker du fungerar bra? </strong> (Finns det något som kan fungera bättre framåt?)</p>
          <p><br></p>
        </div>
      </section>
...
export const mockConversationList: ConversationListItem[] = mockSamtals.map(
  (samtal) => {
    ...
    return {
      ...
      role: "Deltagare",
      status: listStatus,
      bookedTime: samtal.bookedDate
        ? samtal.bookedDate.toLocaleString("sv-SE", {
            dateStyle: "short",
            timeStyle: "short",
          })
        : undefined,
...
export const mockTasks: Task[] = [
  ...
  // ========================================
  {
    ...
    description:
      "Ta större ansvar för strategiska HR-frågor och employer branding",
    status: "pending",
    ...
    origin: {
      conversationId: "hist-anna-2024",
      conversationTitle: "Medarbetarsamtal 2024",
    },
    statusHistory: [
      {
        id: "update-anna-1-3",
        ...
        comment:
          "Har börjat arbeta mer med strategiska frågor. Inledde employer branding-projektet med gott resultat.",
      ...
      },
      {
        ...
        status: "gar_enligt_plan",
        comment:
          "Bra framsteg! Anna deltar nu aktivt i ledningsgruppsmöten och bidrar med HR-perspektiv.",
      ...
      },
      {
        ...
        status: null,
        comment:
          "Målbilden är satt, börjar nu kartlägga vilka strategiska initiativ som behövs.",
        user: annaAndersson as unknown as User,
  ...
  },
  {
    ...
    description:
      "Genomföra CIPD Level 5 certifiering för att fördjupa HR-kompetensen",
    status: "pending",
    goalStatus: null,
    ...
    statusHistory: [
      {
        ...
        status: "gar_enligt_plan",
        comment:
          "NPS ligger nu på 8.2! Nya welcome-kitet har fått fantastisk feedback. Kör vidare mot 9.0.",
        user: erikAxelsson as unknown as User,
      ...
      },
      {
        ...
        status: "ligger_efter",
        comment:
          "Fick lägre NPS än förväntat (7.8). Feedback visar att vi behöver bättre struktur första veckan.",
        user: annaAndersson as unknown as User,
  ...
  // ========================================
  {
    ...
    origin: {
      conversationId: "samtal-karin-2025",
      conversationTitle: "Medarbetarsamtal 2025",
    },
  },
  {
    id: "task-karin-1",
  ...
  },
  {
    ...
    createdAt: new Date("2024-01-15"),
    origin: {
      conversationId: "hist-karin-2024",
      conversationTitle: "Medarbetarsamtal 2024",
    },
  },
  ...
  // ========================================
  {
    ...
    origin: {
      conversationId: "samtal-david-2025",
      conversationTitle: "Lönerevision 2025",
    },
  },
  {
    id: "goal-hist-lisa-1",
    ...
    createdAt: new Date("2024-01-15"),
    origin: {
      conversationId: "hist-lisa-2024",
      conversationTitle: "Lönerevision 2024",
    },
  },
  {
    ...
    origin: {
      conversationId: "hist-marcus-2024",
      conversationTitle: "Lönerevision 2024",
    },
  },
  ...
  // ========================================
  {
    ...
    description:
      "Ta ledande ansvar för QA-strategi och processutveckling inom teamet",
    status: "pending",
    goalStatus: null,
    due: new Date("2026-06-30"),
    assignee: marcusLindqvist as unknown as User,
    ...
    origin: {
      conversationId: "samtal-marcus-2025",
      conversationTitle: "Lönerevision 2025",
    },
  },
  {
    ...
    description:
      "Höja testtäckningen från nuvarande 78% till 85% genom utökad automatisering",
    status: "pending",
    goalStatus: null,
...
<div class="space-y-8">
  <div>
    ...
    aiSummary: {
      overview:
        "Ett positivt medarbetarsamtal med Karin Larsson. Karin mår bra i sin roll och fick energi av att leda Projekt Alpha. Hon vill formalisera sin projektledningskompetens med certifiering och på sikt ta mer budgetansvar.",
      keyDiscussions: [
        ...
        goals: [
          {
            title: "Certifiering i Projektledning",
            status: "completed",
            origin: { conversationId: "hist-karin-2024" },
          },
        ],
        tasks: [],
      },
...
<p>Löneökning 5%.</p>`,
    aiSummary: {
      overview:
        "Lönerevision med Lisa Svensson. Lisa har haft ett starkt säljår och överträffade sina försäljningsmål med 15%. Fokus framåt ligger på att fortsätta växa storkundsportföljen. Löneökning på 5% överenskommen.",
      keyDiscussions: [
        ...
        goals: [
          {
            title: "Öka försäljning Q3 2024",
            status: "completed",
            origin: { conversationId: "hist-lisa-2024" },
          },
        ],
        tasks: [],
      },
...
<p>Löneökning 4%.</p>`,
    aiSummary: {
      overview:
        "Lönerevision med Marcus Lindqvist. Marcus har förbättrat testtäckningen avsevärt under året och levererar konsekvent hög kvalitet. Automatisering av testsviten prioriteras framåt. Löneökning på 4% överenskommen.",
      keyDiscussions: [
        ...
        goals: [
          {
            title: "Automatisera testsvit",
            status: "completed",
            origin: { conversationId: "hist-marcus-2024" },
          },
        ],
        tasks: [],
      },
...
<div class="space-y-8">
  <div>
    ...
    aiSummary: {
      overview:
        "Ett mycket positivt medarbetarsamtal med Anna där vi reflekterade över hennes starka insatser under 2023 och satte ambitiösa mål för 2024. Anna har varit instrumental i att bygga vår rekryteringsprocess och employer branding. Fokus framåt ligger på att skala upp rekryteringen för teknikteamet.",
      keyDiscussions: [
        ...
        goals: [
          {
            title: "Rekrytera 5 utvecklare",
            status: "completed",
            origin: { conversationId: "hist-anna-2024" },
          },
          {
            title: "Implementera nytt ATS-system",
            status: "completed",
...
<div class="space-y-8">
  <div>
    ...
    aiSummary: {
      overview:
        "Annas första medarbetarsamtal efter att ha jobbat hos oss i cirka 5 månader. Hon har gjort ett starkt intryck och redan identifierat viktiga förbättringsområden. Fokus för 2023 är att bygga en skalbar rekryteringsprocess och etablera vårt employer brand.",
      keyDiscussions: [
      ...
      goalsAndTasks: {
        goals: [
          {
            title: "Bygga skalbar rekryteringsprocess",
            status: "completed",
            origin: { conversationId: "hist-anna-2023" },
          },
          {
            title: "Etablera employer brand",
            status: "completed",
            origin: { conversationId: "hist-anna-2023" },
          },
        ],
...
<p>Löneökning 3.5%.</p>`,
    aiSummary: {
      overview:
        "Lönerevision med David Persson. David har varit stabil i backend-teamet under året. Nästa stora fokus är cloud-migrering som David ska leda. Löneökning på 3.5% överenskommen.",
      keyDiscussions: [
      ...
      goalsAndTasks: {
        goals: [
          {
            title: "Migrera till Cloud",
            status: "completed",
            origin: { conversationId: "hist-david-2024" },
          },
        ],
        tasks: [],
      },
